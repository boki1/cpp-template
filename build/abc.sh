...
make_bench() {
  # FIXME: Use proper iteration over directory contents:
  # "Iterating over ls output is fragile" - some wise person said.
...
# if [ "${project_name}" == "templatelib" ]; then
# 	echo "Name is required for the project!"
# 	exit 0
# fi
